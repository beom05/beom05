...
#   - [시작:끝]
#   - [2:5] -> 2~4까지 추출
print(intro[2:7])   # 2~6까지 추출
print(intro[:])     # 처음부터 끝까지 추출
print(intro[:7])    # 처음부터 6까지 추출
print(intro[3:])    # 3부터 끝까지 추출
...
print(intro.find("Python")) # 첫 글자의 인덱스를 알려줌 6
...
mail = ["cherry1004@gmail.com", "cherry01@gmail.com", "cherry0@gmail.com"]
...
print()
address = ["www.naver.com", "www.daum.net", "www.google.com"]
